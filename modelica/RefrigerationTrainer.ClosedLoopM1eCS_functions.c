...
#include "RefrigerationTrainer.ClosedLoopM1eCS_includes.h"
...
{
  RefrigerationTrainer_ClosedLoopM1eCS_Med_SaturationProperties tmp1;
  tmp1._Tsat = omc_Tsat;
  tmp1._dTp = omc_dTp;
...
{
  return mmc_mk_box15(3, &RefrigerationTrainer_ClosedLoopM1eCS_Med_SaturationProperties__desc, _Tsat, _dTp, _ddldp, _ddvdp, _dhldp, _dhvdp, _dl, _dv, _hl, _hv, _psat, _sigma, _sl, _sv);
}
...
{
  RefrigerationTrainer_ClosedLoopM1eCS_Med_ThermodynamicState tmp1;
  tmp1._T = omc_T;
  tmp1._a = omc_a;
  tmp1._beta = omc_beta;
  tmp1._cp = omc_cp;
...
{
  return mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_Med_ThermodynamicState__desc, _T, _a, _beta, _cp, _cv, _d, _ddhp, _ddph, _eta, _h, _kappa, _lambda, _p, _phase, _s);
}
...
{
  double _p_ext;
  RefrigerationTrainer_ClosedLoopM1eCS_Med_SaturationProperties_external _sat_ext;
  ...
  RefrigerationTrainer_ClosedLoopM1eCS_Med_SaturationProperties _sat;
  RefrigerationTrainer_ClosedLoopM1eCS_Med_SaturationProperties_construct(threadData, _sat); // _sat has no default value.
  _p_ext = (double) _p;
  ...
  RefrigerationTrainer_ClosedLoopM1eCS_Med_SaturationProperties_copy_from_external(_sat_ext, _sat);
  return _sat;
}
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_Med_setSat__p(threadData_t *threadData, modelica_metatype _p)
{
  ...
  _sat = omc_RefrigerationTrainer_ClosedLoopM1eCS_Med_setSat__p(threadData, tmp1);
  ...
  out_sat = mmc_mk_box15(3, &RefrigerationTrainer_ClosedLoopM1eCS_Med_SaturationProperties__desc, tmpMeta2, tmpMeta3, tmpMeta4, tmpMeta5, tmpMeta6, tmpMeta7, tmpMeta8, tmpMeta9, tmpMeta10, tmpMeta11, tmpMeta12, tmpMeta13, tmpMeta14, tmpMeta15);
  return out_sat;
}
...
RefrigerationTrainer_ClosedLoopM1eCS_Med_ThermodynamicState omc_RefrigerationTrainer_ClosedLoopM1eCS_Med_setState__ph(threadData_t *threadData, modelica_real _p, modelica_real _h, modelica_integer _phase)
{
  ...
  double _h_ext;
  int _phase_ext;
  RefrigerationTrainer_ClosedLoopM1eCS_Med_ThermodynamicState_external _state_ext;
  static const MMC_DEFSTRINGLIT(tmp1,10,"TestMedium");
  static const MMC_DEFSTRINGLIT(tmp2,8,"CoolProp");
  static const MMC_DEFSTRINGLIT(tmp3,134,"propane|calc_transport=1|enable_TTSE=0|enable_BICUBIC=0|enable_EXTTP=1|twophase_derivsmoothing_xend=0.0|rho_smoothing_xend=0.0|debug=0");
  RefrigerationTrainer_ClosedLoopM1eCS_Med_ThermodynamicState _state;
  RefrigerationTrainer_ClosedLoopM1eCS_Med_ThermodynamicState_construct(threadData, _state); // _state has no default value.
  _p_ext = (double) _p;
  _h_ext = (double) _h;
  ...
  RefrigerationTrainer_ClosedLoopM1eCS_Med_ThermodynamicState_copy_from_external(_state_ext, _state);
  return _state;
}
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_Med_setState__ph(threadData_t *threadData, modelica_metatype _p, modelica_metatype _h, modelica_metatype _phase)
{
  ...
  _state = omc_RefrigerationTrainer_ClosedLoopM1eCS_Med_setState__ph(threadData, tmp1, tmp2, tmp3);
  ...
  out_state = mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_Med_ThermodynamicState__desc, tmpMeta4, tmpMeta5, tmpMeta6, tmpMeta7, tmpMeta8, tmpMeta9, tmpMeta10, tmpMeta11, tmpMeta12, tmpMeta13, tmpMeta14, tmpMeta15, tmpMeta16, tmpMeta17, tmpMeta18);
  return out_state;
}
...
{
  RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_SaturationProperties tmp1;
  tmp1._Tsat = omc_Tsat;
  tmp1._dTp = omc_dTp;
  tmp1._ddldp = omc_ddldp;
  tmp1._ddvdp = omc_ddvdp;
...
{
  return mmc_mk_box15(3, &RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_SaturationProperties__desc, _Tsat, _dTp, _ddldp, _ddvdp, _dhldp, _dhvdp, _dl, _dv, _hl, _hv, _psat, _sigma, _sl, _sv);
}
...
{
  RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_ThermodynamicState tmp1;
  tmp1._T = omc_T;
  tmp1._a = omc_a;
  tmp1._beta = omc_beta;
  tmp1._cp = omc_cp;
...
{
  return mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_ThermodynamicState__desc, _T, _a, _beta, _cp, _cv, _d, _ddhp, _ddph, _eta, _h, _kappa, _lambda, _p, _phase, _s);
}
...
{
  double _p_ext;
  RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_SaturationProperties_external _sat_ext;
  static const MMC_DEFSTRINGLIT(tmp1,10,"TestMedium");
  static const MMC_DEFSTRINGLIT(tmp2,8,"CoolProp");
  static const MMC_DEFSTRINGLIT(tmp3,134,"propane|calc_transport=1|enable_TTSE=0|enable_BICUBIC=0|enable_EXTTP=1|twophase_derivsmoothing_xend=0.0|rho_smoothing_xend=0.0|debug=0");
  RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_SaturationProperties _sat;
  RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_SaturationProperties_construct(threadData, _sat); // _sat has no default value.
  _p_ext = (double) _p;
  TwoPhaseMedium_setSat_p_C_impl(_p_ext, &_sat_ext, MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp1)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp2)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp3)));
  RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_SaturationProperties_copy_from_external(_sat_ext, _sat);
  return _sat;
}
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_setSat__p(threadData_t *threadData, modelica_metatype _p)
{
  ...
  modelica_metatype out_sat;
  tmp1 = mmc_unbox_real(_p);
  _sat = omc_RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_setSat__p(threadData, tmp1);
  tmpMeta2 = mmc_mk_rcon(_sat._Tsat);
  tmpMeta3 = mmc_mk_rcon(_sat._dTp);
  tmpMeta4 = mmc_mk_rcon(_sat._ddldp);
  tmpMeta5 = mmc_mk_rcon(_sat._ddvdp);
  ...
  tmpMeta14 = mmc_mk_rcon(_sat._sl);
  tmpMeta15 = mmc_mk_rcon(_sat._sv);
  out_sat = mmc_mk_box15(3, &RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_SaturationProperties__desc, tmpMeta2, tmpMeta3, tmpMeta4, tmpMeta5, tmpMeta6, tmpMeta7, tmpMeta8, tmpMeta9, tmpMeta10, tmpMeta11, tmpMeta12, tmpMeta13, tmpMeta14, tmpMeta15);
  return out_sat;
}
...
RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_ThermodynamicState omc_RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_setState__pT(threadData_t *threadData, modelica_real _p, modelica_real _T, modelica_integer _phase)
{
  double _p_ext;
  double _T_ext;
  RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_ThermodynamicState_external _state_ext;
  static const MMC_DEFSTRINGLIT(tmp1,10,"TestMedium");
  static const MMC_DEFSTRINGLIT(tmp2,8,"CoolProp");
  static const MMC_DEFSTRINGLIT(tmp3,134,"propane|calc_transport=1|enable_TTSE=0|enable_BICUBIC=0|enable_EXTTP=1|twophase_derivsmoothing_xend=0.0|rho_smoothing_xend=0.0|debug=0");
  RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_ThermodynamicState _state;
  RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_ThermodynamicState_construct(threadData, _state); // _state has no default value.
  _p_ext = (double) _p;
  _T_ext = (double) _T;
  ...
  RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_ThermodynamicState_copy_from_external(_state_ext, _state);
  return _state;
}
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_setState__pT(threadData_t *threadData, modelica_metatype _p, modelica_metatype _T, modelica_metatype _phase)
{
  ...
  tmp3 = mmc_unbox_integer(_phase);
  _state = omc_RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_setState__pT(threadData, tmp1, tmp2, tmp3);
  tmpMeta4 = mmc_mk_rcon(_state._T);
  tmpMeta5 = mmc_mk_rcon(_state._a);
  tmpMeta6 = mmc_mk_rcon(_state._beta);
  tmpMeta7 = mmc_mk_rcon(_state._cp);
  ...
  tmpMeta17 = mmc_mk_icon(_state._phase);
  tmpMeta18 = mmc_mk_rcon(_state._s);
  out_state = mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_ThermodynamicState__desc, tmpMeta4, tmpMeta5, tmpMeta6, tmpMeta7, tmpMeta8, tmpMeta9, tmpMeta10, tmpMeta11, tmpMeta12, tmpMeta13, tmpMeta14, tmpMeta15, tmpMeta16, tmpMeta17, tmpMeta18);
  return out_state;
}
...
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_setState__ph(threadData_t *threadData, modelica_metatype _p, modelica_metatype _h, modelica_metatype _phase)
{
  ...
  tmp2 = mmc_unbox_real(_h);
  tmp3 = mmc_unbox_integer(_phase);
  _state = omc_RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_setState__ph(threadData, tmp1, tmp2, tmp3);
  tmpMeta4 = mmc_mk_rcon(_state._T);
  tmpMeta5 = mmc_mk_rcon(_state._a);
  tmpMeta6 = mmc_mk_rcon(_state._beta);
  tmpMeta7 = mmc_mk_rcon(_state._cp);
...
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_setState__ps(threadData_t *threadData, modelica_metatype _p, modelica_metatype _s, modelica_metatype _phase)
{
  ...
  tmp3 = mmc_unbox_integer(_phase);
  _state = omc_RefrigerationTrainer_ClosedLoopM1eCS_comp_Medium_setState__ps(threadData, tmp1, tmp2, tmp3);
  tmpMeta4 = mmc_mk_rcon(_state._T);
  tmpMeta5 = mmc_mk_rcon(_state._a);
  tmpMeta6 = mmc_mk_rcon(_state._beta);
  tmpMeta7 = mmc_mk_rcon(_state._cp);
...
{
  return mmc_mk_box15(3, &RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_SaturationProperties__desc, _Tsat, _dTp, _ddldp, _ddvdp, _dhldp, _dhvdp, _dl, _dv, _hl, _hv, _psat, _sigma, _sl, _sv);
}
...
{
  RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_ThermodynamicState tmp1;
  tmp1._T = omc_T;
  tmp1._a = omc_a;
  tmp1._beta = omc_beta;
  tmp1._cp = omc_cp;
...
{
  return mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_ThermodynamicState__desc, _T, _a, _beta, _cp, _cv, _d, _ddhp, _ddph, _eta, _h, _kappa, _lambda, _p, _phase, _s);
}
...
{
  double _p_ext;
  RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_SaturationProperties_external _sat_ext;
  static const MMC_DEFSTRINGLIT(tmp1,10,"TestMedium");
  static const MMC_DEFSTRINGLIT(tmp2,8,"CoolProp");
  static const MMC_DEFSTRINGLIT(tmp3,134,"propane|calc_transport=1|enable_TTSE=0|enable_BICUBIC=0|enable_EXTTP=1|twophase_derivsmoothing_xend=0.0|rho_smoothing_xend=0.0|debug=0");
  RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_SaturationProperties _sat;
  RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_SaturationProperties_construct(threadData, _sat); // _sat has no default value.
  _p_ext = (double) _p;
  TwoPhaseMedium_setSat_p_C_impl(_p_ext, &_sat_ext, MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp1)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp2)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp3)));
  RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_SaturationProperties_copy_from_external(_sat_ext, _sat);
  return _sat;
}
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_setSat__p(threadData_t *threadData, modelica_metatype _p)
{
  ...
  modelica_metatype out_sat;
  tmp1 = mmc_unbox_real(_p);
  _sat = omc_RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_setSat__p(threadData, tmp1);
  tmpMeta2 = mmc_mk_rcon(_sat._Tsat);
  tmpMeta3 = mmc_mk_rcon(_sat._dTp);
  tmpMeta4 = mmc_mk_rcon(_sat._ddldp);
  tmpMeta5 = mmc_mk_rcon(_sat._ddvdp);
  ...
  tmpMeta14 = mmc_mk_rcon(_sat._sl);
  tmpMeta15 = mmc_mk_rcon(_sat._sv);
  out_sat = mmc_mk_box15(3, &RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_SaturationProperties__desc, tmpMeta2, tmpMeta3, tmpMeta4, tmpMeta5, tmpMeta6, tmpMeta7, tmpMeta8, tmpMeta9, tmpMeta10, tmpMeta11, tmpMeta12, tmpMeta13, tmpMeta14, tmpMeta15);
  return out_sat;
}
...
RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_ThermodynamicState omc_RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_setState__ph(threadData_t *threadData, modelica_real _p, modelica_real _h, modelica_integer _phase)
{
  ...
  double _h_ext;
  int _phase_ext;
  RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_ThermodynamicState_external _state_ext;
  static const MMC_DEFSTRINGLIT(tmp1,10,"TestMedium");
  static const MMC_DEFSTRINGLIT(tmp2,8,"CoolProp");
  static const MMC_DEFSTRINGLIT(tmp3,134,"propane|calc_transport=1|enable_TTSE=0|enable_BICUBIC=0|enable_EXTTP=1|twophase_derivsmoothing_xend=0.0|rho_smoothing_xend=0.0|debug=0");
  RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_ThermodynamicState _state;
  RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_ThermodynamicState_construct(threadData, _state); // _state has no default value.
  _p_ext = (double) _p;
  _h_ext = (double) _h;
  _phase_ext = (int) _phase;
  TwoPhaseMedium_setState_ph_C_impl_wrap(_p_ext, _h_ext, _phase_ext, &_state_ext, MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp1)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp2)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp3)));
  RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_ThermodynamicState_copy_from_external(_state_ext, _state);
  return _state;
}
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_setState__ph(threadData_t *threadData, modelica_metatype _p, modelica_metatype _h, modelica_metatype _phase)
{
  ...
  tmp2 = mmc_unbox_real(_h);
  tmp3 = mmc_unbox_integer(_phase);
  _state = omc_RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_setState__ph(threadData, tmp1, tmp2, tmp3);
  tmpMeta4 = mmc_mk_rcon(_state._T);
  tmpMeta5 = mmc_mk_rcon(_state._a);
  tmpMeta6 = mmc_mk_rcon(_state._beta);
  tmpMeta7 = mmc_mk_rcon(_state._cp);
  ...
  tmpMeta17 = mmc_mk_icon(_state._phase);
  tmpMeta18 = mmc_mk_rcon(_state._s);
  out_state = mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_Medium_ThermodynamicState__desc, tmpMeta4, tmpMeta5, tmpMeta6, tmpMeta7, tmpMeta8, tmpMeta9, tmpMeta10, tmpMeta11, tmpMeta12, tmpMeta13, tmpMeta14, tmpMeta15, tmpMeta16, tmpMeta17, tmpMeta18);
  return out_state;
}
...
{
  RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_heatTransfer_Medium_ThermodynamicState tmp1;
  tmp1._T = omc_T;
  tmp1._a = omc_a;
  tmp1._beta = omc_beta;
  tmp1._cp = omc_cp;
...
{
  return mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_cond_Cells_heatTransfer_Medium_ThermodynamicState__desc, _T, _a, _beta, _cp, _cv, _d, _ddhp, _ddph, _eta, _h, _kappa, _lambda, _p, _phase, _s);
}
...
{
  RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_SaturationProperties tmp1;
  tmp1._Tsat = omc_Tsat;
  tmp1._dTp = omc_dTp;
  tmp1._ddldp = omc_ddldp;
  tmp1._ddvdp = omc_ddvdp;
...
{
  return mmc_mk_box15(3, &RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_SaturationProperties__desc, _Tsat, _dTp, _ddldp, _ddvdp, _dhldp, _dhvdp, _dl, _dv, _hl, _hv, _psat, _sigma, _sl, _sv);
}
...
{
  RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_ThermodynamicState tmp1;
  tmp1._T = omc_T;
  tmp1._a = omc_a;
  tmp1._beta = omc_beta;
  tmp1._cp = omc_cp;
...
{
  return mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_ThermodynamicState__desc, _T, _a, _beta, _cp, _cv, _d, _ddhp, _ddph, _eta, _h, _kappa, _lambda, _p, _phase, _s);
}
...
{
  double _p_ext;
  RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_SaturationProperties_external _sat_ext;
  static const MMC_DEFSTRINGLIT(tmp1,10,"TestMedium");
  static const MMC_DEFSTRINGLIT(tmp2,8,"CoolProp");
  static const MMC_DEFSTRINGLIT(tmp3,134,"propane|calc_transport=1|enable_TTSE=0|enable_BICUBIC=0|enable_EXTTP=1|twophase_derivsmoothing_xend=0.0|rho_smoothing_xend=0.0|debug=0");
  RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_SaturationProperties _sat;
  RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_SaturationProperties_construct(threadData, _sat); // _sat has no default value.
  _p_ext = (double) _p;
  TwoPhaseMedium_setSat_p_C_impl(_p_ext, &_sat_ext, MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp1)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp2)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp3)));
  RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_SaturationProperties_copy_from_external(_sat_ext, _sat);
  return _sat;
}
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_setSat__p(threadData_t *threadData, modelica_metatype _p)
{
  ...
  modelica_metatype out_sat;
  tmp1 = mmc_unbox_real(_p);
  _sat = omc_RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_setSat__p(threadData, tmp1);
  tmpMeta2 = mmc_mk_rcon(_sat._Tsat);
  tmpMeta3 = mmc_mk_rcon(_sat._dTp);
  tmpMeta4 = mmc_mk_rcon(_sat._ddldp);
  tmpMeta5 = mmc_mk_rcon(_sat._ddvdp);
  ...
  tmpMeta14 = mmc_mk_rcon(_sat._sl);
  tmpMeta15 = mmc_mk_rcon(_sat._sv);
  out_sat = mmc_mk_box15(3, &RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_SaturationProperties__desc, tmpMeta2, tmpMeta3, tmpMeta4, tmpMeta5, tmpMeta6, tmpMeta7, tmpMeta8, tmpMeta9, tmpMeta10, tmpMeta11, tmpMeta12, tmpMeta13, tmpMeta14, tmpMeta15);
  return out_sat;
}
...
RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_ThermodynamicState omc_RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_setState__ph(threadData_t *threadData, modelica_real _p, modelica_real _h, modelica_integer _phase)
{
  ...
  double _h_ext;
  int _phase_ext;
  RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_ThermodynamicState_external _state_ext;
  static const MMC_DEFSTRINGLIT(tmp1,10,"TestMedium");
  static const MMC_DEFSTRINGLIT(tmp2,8,"CoolProp");
  static const MMC_DEFSTRINGLIT(tmp3,134,"propane|calc_transport=1|enable_TTSE=0|enable_BICUBIC=0|enable_EXTTP=1|twophase_derivsmoothing_xend=0.0|rho_smoothing_xend=0.0|debug=0");
  RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_ThermodynamicState _state;
  RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_ThermodynamicState_construct(threadData, _state); // _state has no default value.
  _p_ext = (double) _p;
  _h_ext = (double) _h;
  _phase_ext = (int) _phase;
  TwoPhaseMedium_setState_ph_C_impl_wrap(_p_ext, _h_ext, _phase_ext, &_state_ext, MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp1)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp2)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp3)));
  RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_ThermodynamicState_copy_from_external(_state_ext, _state);
  return _state;
}
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_setState__ph(threadData_t *threadData, modelica_metatype _p, modelica_metatype _h, modelica_metatype _phase)
{
  ...
  tmp2 = mmc_unbox_real(_h);
  tmp3 = mmc_unbox_integer(_phase);
  _state = omc_RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_setState__ph(threadData, tmp1, tmp2, tmp3);
  tmpMeta4 = mmc_mk_rcon(_state._T);
  tmpMeta5 = mmc_mk_rcon(_state._a);
  tmpMeta6 = mmc_mk_rcon(_state._beta);
  tmpMeta7 = mmc_mk_rcon(_state._cp);
  ...
  tmpMeta17 = mmc_mk_icon(_state._phase);
  tmpMeta18 = mmc_mk_rcon(_state._s);
  out_state = mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_Medium_ThermodynamicState__desc, tmpMeta4, tmpMeta5, tmpMeta6, tmpMeta7, tmpMeta8, tmpMeta9, tmpMeta10, tmpMeta11, tmpMeta12, tmpMeta13, tmpMeta14, tmpMeta15, tmpMeta16, tmpMeta17, tmpMeta18);
  return out_state;
}
...
{
  RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_heatTransfer_Medium_ThermodynamicState tmp1;
  tmp1._T = omc_T;
  tmp1._a = omc_a;
  tmp1._beta = omc_beta;
  tmp1._cp = omc_cp;
...
{
  return mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_evap_Cells_heatTransfer_Medium_ThermodynamicState__desc, _T, _a, _beta, _cp, _cv, _d, _ddhp, _ddph, _eta, _h, _kappa, _lambda, _p, _phase, _s);
}
...
{
  RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_ThermodynamicState tmp1;
  tmp1._T = omc_T;
  tmp1._a = omc_a;
  tmp1._beta = omc_beta;
  tmp1._cp = omc_cp;
...
{
  return mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_ThermodynamicState__desc, _T, _a, _beta, _cp, _cv, _d, _ddhp, _ddph, _eta, _h, _kappa, _lambda, _p, _phase, _s);
}
...
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_density(threadData_t *threadData, modelica_metatype _state)
{
  ...
  tmp1._s = tmp31;
  _d = omc_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_density(threadData, tmp1);
...
modelica_real omc_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_density__pTX(threadData_t *threadData, modelica_real _p, modelica_real _T, real_array _X)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _d has no default value.
  _d = omc_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_density(threadData, omc_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_setState__pTX(threadData, _p, _T, _X, ((modelica_integer) 0)));
  _return: OMC_LABEL_UNUSED
  return _d;
}
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_density__pTX(threadData_t *threadData, modelica_metatype _p, modelica_metatype _T, modelica_metatype _X)
{
  ...
  tmp1 = mmc_unbox_real(_p);
  tmp2 = mmc_unbox_real(_T);
  _d = omc_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_density__pTX(threadData, tmp1, tmp2, *((base_array_t*)_X));
  out_d = mmc_mk_rcon(_d);
  return out_d;
}
...
RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_ThermodynamicState omc_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_setState__pT(threadData_t *threadData, modelica_real _p, modelica_real _T, modelica_integer _phase)
{
  double _p_ext;
  double _T_ext;
  RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_ThermodynamicState_external _state_ext;
  static const MMC_DEFSTRINGLIT(tmp1,10,"TestMedium");
  static const MMC_DEFSTRINGLIT(tmp2,8,"CoolProp");
  static const MMC_DEFSTRINGLIT(tmp3,134,"propane|calc_transport=1|enable_TTSE=0|enable_BICUBIC=0|enable_EXTTP=1|twophase_derivsmoothing_xend=0.0|rho_smoothing_xend=0.0|debug=0");
  RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_ThermodynamicState _state;
  RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_ThermodynamicState_construct(threadData, _state); // _state has no default value.
  _p_ext = (double) _p;
  _T_ext = (double) _T;
  TwoPhaseMedium_setState_pT_C_impl_wrap(_p_ext, _T_ext, &_state_ext, MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp1)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp2)), MMC_STRINGDATA(MMC_REFSTRINGLIT(tmp3)));
  RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_ThermodynamicState_copy_from_external(_state_ext, _state);
  return _state;
}
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_setState__pT(threadData_t *threadData, modelica_metatype _p, modelica_metatype _T, modelica_metatype _phase)
{
  ...
  tmp2 = mmc_unbox_real(_T);
  tmp3 = mmc_unbox_integer(_phase);
  _state = omc_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_setState__pT(threadData, tmp1, tmp2, tmp3);
  tmpMeta4 = mmc_mk_rcon(_state._T);
  tmpMeta5 = mmc_mk_rcon(_state._a);
  tmpMeta6 = mmc_mk_rcon(_state._beta);
  tmpMeta7 = mmc_mk_rcon(_state._cp);
  ...
  tmpMeta17 = mmc_mk_icon(_state._phase);
  tmpMeta18 = mmc_mk_rcon(_state._s);
  out_state = mmc_mk_box16(3, &RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_ThermodynamicState__desc, tmpMeta4, tmpMeta5, tmpMeta6, tmpMeta7, tmpMeta8, tmpMeta9, tmpMeta10, tmpMeta11, tmpMeta12, tmpMeta13, tmpMeta14, tmpMeta15, tmpMeta16, tmpMeta17, tmpMeta18);
  return out_state;
}
...
RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_ThermodynamicState omc_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_setState__pTX(threadData_t *threadData, modelica_real _p, modelica_real _T, real_array _X, modelica_integer _phase)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_ThermodynamicState_construct(threadData, _state); // _state has no default value.
  tmp1 = omc_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_setState__pT(threadData, _p, _T, _phase);
  RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_ThermodynamicState_copy(tmp1, _state);;
  _return: OMC_LABEL_UNUSED
  return _state;
}
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_setState__pTX(threadData_t *threadData, modelica_metatype _p, modelica_metatype _T, modelica_metatype _X, modelica_metatype _phase)
{
  ...
  tmp2 = mmc_unbox_real(_T);
  tmp3 = mmc_unbox_integer(_phase);
  _state = omc_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_setState__pTX(threadData, tmp1, tmp2, *((base_array_t*)_X), tmp3);
  tmpMeta4 = mmc_mk_rcon(_state._T);
  tmpMeta5 = mmc_mk_rcon(_state._a);
  tmpMeta6 = mmc_mk_rcon(_state._beta);
  tmpMeta7 = mmc_mk_rcon(_state._cp);
...
modelica_metatype boxptr_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_setState__ph(threadData_t *threadData, modelica_metatype _p, modelica_metatype _h, modelica_metatype _phase)
{
  ...
  tmp2 = mmc_unbox_real(_h);
  tmp3 = mmc_unbox_integer(_phase);
  _state = omc_RefrigerationTrainer_ClosedLoopM1eCS_txv_Medium_setState__ph(threadData, tmp1, tmp2, tmp3);
  tmpMeta4 = mmc_mk_rcon(_state._T);
  tmpMeta5 = mmc_mk_rcon(_state._a);
  tmpMeta6 = mmc_mk_rcon(_state._beta);
  tmpMeta7 = mmc_mk_rcon(_state._cp);
