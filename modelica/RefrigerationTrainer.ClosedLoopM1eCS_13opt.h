  ...
  extern "C" {
#endif
  int RefrigerationTrainer_ClosedLoopM1eCS_mayer(DATA* data, modelica_real** res, short*);
  int RefrigerationTrainer_ClosedLoopM1eCS_lagrange(DATA* data, modelica_real** res, short *, short *);
